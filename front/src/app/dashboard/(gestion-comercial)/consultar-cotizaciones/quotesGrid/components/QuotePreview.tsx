...
import { TECHNOLOGY_LABELS } from "../../../generar-cotizacion/types/quotes.types";
...
export function QuotePreview({ quote }: QuotePreviewProps) {
  const formatDate = (dateStr?: string) => {
    if (!dateStr) return "—";
    // Agregar T12:00:00 para evitar desfase de zona horaria en fechas sin hora
    ...
    <div className="p-6 sm:p-8 space-y-6">
      ...
      <div className="border-b pb-6">
        <div className="flex items-start justify-between">
          <div>
            {/* Aquí puedes poner tu logo corporativo */}
      ...
      {/* ── Sección 5: Implementación y Totales ─────────────────────────── */}
      <section>
        <h2 className="text-sm font-semibold text-elena-pink-600 uppercase tracking-wider mb-3">
          Resumen Económico
        </h2>
