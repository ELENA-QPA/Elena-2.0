...
import { downloadQuotePdf } from "../../../api/quotes.service";
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            {quote.quoteStatus === "draft" && (
              <>
                <Link
                  href={`/dashboard/gestion-comercial/generar-cotizacion?edit=${quote._id}`}
                >
                  <Button
                    variant="outline"
                    size="sm"
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    toast.info(
                      "Funcionalidad de envío por correo próximamente",
                    );
                  }}
                >
