...
export async function middleware(request: NextRequest) {
    ...
    try {
        ...
        const normalizedUser = {
            ...
            rol: Array.isArray(user.roles) ? user.roles : (user.roles ? [user.roles] : []), // Para compatibilidad con localStorage
        ...
        if (error.code === 'ECONNABORTED' || error.code === 'ENOTFOUND' || error.code === 'ECONNREFUSED') {
            console.log('[MIDDLEWARE][Connectivity Error]: Error de conectividad, permitiendo acceso temporal');
